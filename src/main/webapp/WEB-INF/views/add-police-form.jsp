...
<script type="text/javascript">
	...
	var policeRankCheck = function() {
		var nameRegex = new RegExp("^[a-zA-z\s]+$");
		if (!document.form.policeRank.value.match(nameRegex)) {
			if (alert("Rank can't be empty or must contain only alphabets")) {
				document.form.policeRank.focus();
			} else
				...
				<div>
					...
					<div>
						<form:input path="policeName" placeholder="Enter Name"
							required="true" pattern="^[a-zA-z\s]+$" name="policeName"
							onblur="policeNameCheck();" />
					</div>
				...
				<div>
					...
					<div>
						<form:input path="mobileNo" placeholder="Enter Mobile Number"
							required="true" pattern='[0-9]{10}' name="mobileNo"
							onblur="mobileNoCheck();" />
					</div>
				...
				<div>
					...
					<div>
						<form:input path="dateOfbirth" type="date"
							style="width: 170px;height: 22px;" required="true"
							name="dateOfbirth" onblur="dateOfbirthCheck();" />
					</div>
